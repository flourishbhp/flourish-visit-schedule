...
a_crf_2000 = FormsCollection(
    ...
    Crf(show_order=14, model='flourish_caregiver.caregiveredinburghdeprscreening',
        required=False),
    Crf(show_order=15, model='flourish_caregiver.caregiveredinburghreferral',
        required=False),
    Crf(show_order=16, model='flourish_caregiver.caregivergadanxietyscreening'),
    Crf(show_order=17, model='flourish_caregiver.caregivergadreferral',
        required=False),
...
a_crf_3000 = FormsCollection(
    ...
    Crf(show_order=10, model='flourish_caregiver.maternalinterimidcc',
        required=False),
    name='a_follow_up')
...
b_crf_3000 = FormsCollection(
    ...
    Crf(show_order=9, model='flourish_caregiver.cliniciannotes'),
