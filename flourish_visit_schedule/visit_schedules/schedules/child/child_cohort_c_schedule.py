...
child_c_enrollment_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C Child Enrollment Schedule',
...
child_c_fu_schedule_1 = Schedule(
    ...
    sequence='3',
    verbose_name='Cohort C Child Follow Up Schedule',
...
child_c_quarterly_schedule_1 = Schedule(
    ...
    sequence='2',
    verbose_name='Cohort C Child Quarterly Schedule',
...
child_c_sec_schedule_1 = Schedule(
    ...
    sequence='1',
    verbose_name='Cohort C Secondary Aims Schedule',
...
child_pool_schedule_1 = Schedule(
    ...
    verbose_name='Child Pool Schedule',
...
child_c_sec_qt_schedule_1 = Schedule(
    ...
    sequence='2',
    verbose_name='Cohort C Secondary Aims Quarterly Schedule',
